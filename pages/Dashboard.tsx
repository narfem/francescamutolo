...
export const DEFAULT_ARTIST_QUESTIONS = {
  step1: {
    title: "1. L'artista che vuoi essere",
    q1_text: "Quando sei con le persone con cui ti senti più a tuo agio, come ti comporti di solito?",
    q1_subtext: "Scegli massimo 3 risposte.",
    q1_options: [
      "Parlo molto",
    ...
    q2_text: "Quali caratteristiche senti più vicine al tuo modo di essere?",
    q2_subtext: "Scegli massimo 3 risposte.",
    q2_options: [
      "Sicuro di me",
      "Ambizioso",
      "Determinato",
    ...
    q3_text: "Quali artisti ti ispirano maggiormente?",
    q3_placeholder: "La tua risposta...",
    q4_text: "Cosa ti piace di loro?",
    q4_subtext: "Può essere il modo di fare musica, il carattere, l'immagine, il modo di stare sul palco o qualsiasi altra cosa.",
    q4_placeholder: "La tua risposta...",
    q5_text: "C'è un artista al quale non vorresti essere associato? Perché?",
    q5_placeholder: "La tua risposta...",
    q6_text: "Se potessi prendere una caratteristica di un artista che ammiri e farla diventare parte della tua identità, quale sceglieresti?",
    q6_placeholder: "La tua risposta..."
  },
  step2: {
    title: "2. Come sei e come ti viene naturale esprimerti",
    q7_text: "Indicatore di personalità 1",
    q7_leftLabel: "Introverso",
    q7_rightLabel: "Estroverso",
    q8_text: "Indicatore di personalità 2",
    q8_leftLabel: "Calmo",
    q8_rightLabel: "Esplosivo",
    q9_text: "Indicatore di personalità 3",
    q9_leftLabel: "Razionale",
    q9_rightLabel: "Istintivo",
    q10_text: "Indicatore di personalità 4",
    q10_leftLabel: "Serio",
    q10_rightLabel: "Ironico",
    q11_text: "Indicatore di personalità 5",
    q11_leftLabel: "Spontaneo",
    q11_rightLabel: "Controllato",
    q12_text: "Indicatore di personalità 6",
    q12_leftLabel: "Discreto",
    q12_rightLabel: "Protagonista",
    q13_text: "Indicatore di personalità 7",
    q13_leftLabel: "Diretto",
    q13_rightLabel: "Misterioso"
  },
  step3: {
    title: "3. Come vuoi essere percepito",
    q14_text: "Scegli 5 parole che descrivono meglio la sensazione che vorresti trasmettere quando le persone entrano nel tuo universo artistico.",
    q14_subtext: "Seleziona esattamente 5 parole.",
    q14_options: [
      "Potente",
      "Libero",
      "Sicuro",
    ...
    q15_text: "Metti in classifica le 3 parole più importanti che hai scelto alla domanda precedente.",
    q15_subtext: "Ordina le 3 parole principali per livello di importanza.",
    q16_text: "Quando una persona ascolta per la prima volta una tua canzone, quali sensazioni vorresti che provasse?",
    q16_subtext: "Scegli e metti in classifica le 5 più importanti.",
    q16_options: [
      "Voglia di muoversi",
      "Adrenalina",
      "Carica",
  ...
  step4: {
    ...
    q17_text: "Scegli 5 concetti che senti più vicini alla tua identità artistica e mettili in classifica.",
    q17_subtext: "Seleziona massimo 5 elementi e successivo ordinamento.",
    q17_options: [
      "Energia",
      "Ambizione",
      "Libertà",
  ...
  step5: {
    ...
    q18_text: "C'è un'esperienza, una persona o un periodo della tua vita che ha contribuito a renderti la persona e l'artista che sei oggi?",
    q18_subtext: "In che modo ha influenzato il tuo carattere, il tuo modo di vedere le cose o il tuo modo di fare musica?",
    q18_placeholder: "La tua risposta...",
    q19_text: "Qual è una cosa che hai fatto o raggiunto e di cui sei realmente orgoglioso?",
    q19_subtext: "Cosa rappresenta per te?",
    q19_placeholder: "La tua risposta...",
    q20_text: "C'è qualcosa che senti di dover dimostrare attraverso la musica?",
    q20_subtext: "Se sì, a chi o a te stesso?",
    q20_placeholder: "La tua risposta...",
    q21_text: "Quale caratteristica di te vorresti mantenere anche se la tua carriera dovesse cambiare completamente la tua vita?",
    q21_placeholder: "La tua risposta..."
  },
  step6: {
    title: "6. Cosa vuoi ottenere attraverso la musica",
    q22_text: "Quale effetto vorresti che la tua musica avesse sulle persone?",
    q22_subtext: "Scegli e metti in classifica i 3 più importanti.",
    q22_options: [
      "Farle divertire",
    ...
    q23_text: "Quali elementi vorresti diventassero riconoscibili e associabili al tuo nome nel tempo?",
    q23_subtext: "Scegli massimo 4.",
    q23_options: [
      "La mia voce",
      "I miei testi",
      "Il mio stile visivo",
    ...
    q24_text: "Qual è la cosa che desideri di più ottenere attraverso la musica?",
    q24_subtext: "Scegli massimo 3.",
    q24_options: [
      "Successo",
      "Riconoscibilità",
      "Rispetto",
  ...
  step7: {
    ...
    q25_text: "I MOOD VISIVI",
    q25_subtext: "Osserva tutti i mood visivi e scegli quelli che senti più vicini a te e al tipo di artista che vorresti diventare.",
    q25_label: "Scrivi qui i numeri dei mood che ti rappresentano maggiormente e, se vuoi, aggiungi una breve spiegazione del perché.",
    q25_placeholder: "Es. Tavola 1: 02, 06. Tavola 2: 09. Mi piacciono perché...",
    q26_text: "I SIMBOLI",
    q26_subtext: "Osserva tutti i simboli e scegli quelli che senti più vicini a te. Non pensare al significato del simbolo in relazione alla musica: concentrati semplicemente sulla forma, sul carattere e sulla sensazione che ti trasmette.",
    q26_label: "Scrivi qui i numeri dei simboli che ti piacciono maggiormente e, se vuoi, aggiungi una breve spiegazione del perché.",
    q26_placeholder: "Es. Simbolo 04 e 15 perché..."
  }
};
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-3 mb-8">
              {(editingTarget === 'brand' ? [
                ...
                { num: 3, name: 'Percezione', icon: Eye },
                { num: 4, name: 'Concetti', icon: Heart },
                { num: 5, name: 'Storia', icon: BookOpen },
                { num: 6, name: 'Obiettivi', icon: Award },
                { num: 7, name: 'Mood & Simboli', icon: Palette },
              ]).map((st) => {
              ...
              <div className="space-y-5">
                {(editingTarget === 'brand' ? questionsSchema : artistQuestionsSchema) && (
                  editingTarget === 'brand' ? [
                    ...
                    { step: 1, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q1_text', label: 'Domanda 1: Testo (comportamento con persone a proprio agio)', type: 'textarea' },
                      { field: 'q1_subtext', label: 'Domanda 1: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q1_options', label: 'Domanda 1: Opzioni (separate da virgola)', type: 'array' },
                      { field: 'q2_text', label: 'Domanda 2: Testo (caratteristiche modo di essere)', type: 'textarea' },
                      { field: 'q2_subtext', label: 'Domanda 2: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q2_options', label: 'Domanda 2: Opzioni (separate da virgola)', type: 'array' },
                      { field: 'q3_text', label: 'Domanda 3: Testo (artisti di ispirazione)', type: 'textarea' },
                      { field: 'q3_placeholder', label: 'Segnaposto: Domanda 3', type: 'text' },
                      { field: 'q4_text', label: 'Domanda 4: Testo (cosa ti piace di loro)', type: 'textarea' },
                      { field: 'q4_subtext', label: 'Domanda 4: Sottotesto', type: 'textarea' },
                      { field: 'q4_placeholder', label: 'Segnaposto: Domanda 4', type: 'text' },
                      { field: 'q5_text', label: 'Domanda 5: Testo (artista da non associare)', type: 'textarea' },
                      { field: 'q5_placeholder', label: 'Segnaposto: Domanda 5', type: 'text' },
                      { field: 'q6_text', label: 'Domanda 6: Testo (caratteristica da fare propria)', type: 'textarea' },
                      { field: 'q6_placeholder', label: 'Segnaposto: Domanda 6', type: 'text' },
                    ]},
                    { step: 2, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q7_text', label: 'Domanda 7 (Indicatore 1): Titolo', type: 'text' },
                      { field: 'q7_leftLabel', label: 'Indicatore 1: Polo Sinistro', type: 'text' },
                      { field: 'q7_rightLabel', label: 'Indicatore 1: Polo Destro', type: 'text' },
                      { field: 'q8_text', label: 'Domanda 8 (Indicatore 2): Titolo', type: 'text' },
                      { field: 'q8_leftLabel', label: 'Indicatore 2: Polo Sinistro', type: 'text' },
                      { field: 'q8_rightLabel', label: 'Indicatore 2: Polo Destro', type: 'text' },
                      { field: 'q9_text', label: 'Domanda 9 (Indicatore 3): Titolo', type: 'text' },
                      { field: 'q9_leftLabel', label: 'Indicatore 3: Polo Sinistro', type: 'text' },
                      { field: 'q9_rightLabel', label: 'Indicatore 3: Polo Destro', type: 'text' },
                      { field: 'q10_text', label: 'Domanda 10 (Indicatore 4): Titolo', type: 'text' },
                      { field: 'q10_leftLabel', label: 'Indicatore 4: Polo Sinistro', type: 'text' },
                      { field: 'q10_rightLabel', label: 'Indicatore 4: Polo Destro', type: 'text' },
                      { field: 'q11_text', label: 'Domanda 11 (Indicatore 5): Titolo', type: 'text' },
                      { field: 'q11_leftLabel', label: 'Indicatore 5: Polo Sinistro', type: 'text' },
                      { field: 'q11_rightLabel', label: 'Indicatore 5: Polo Destro', type: 'text' },
                      { field: 'q12_text', label: 'Domanda 12 (Indicatore 6): Titolo', type: 'text' },
                      { field: 'q12_leftLabel', label: 'Indicatore 6: Polo Sinistro', type: 'text' },
                      { field: 'q12_rightLabel', label: 'Indicatore 6: Polo Destro', type: 'text' },
                      { field: 'q13_text', label: 'Domanda 13 (Indicatore 7): Titolo', type: 'text' },
                      { field: 'q13_leftLabel', label: 'Indicatore 7: Polo Sinistro', type: 'text' },
                      { field: 'q13_rightLabel', label: 'Indicatore 7: Polo Destro', type: 'text' },
                    ]},
                    { step: 3, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q14_text', label: 'Domanda 14: Testo (5 parole universo artistico)', type: 'textarea' },
                      { field: 'q14_subtext', label: 'Domanda 14: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q14_options', label: 'Domanda 14: Opzioni parole (separate da virgola)', type: 'array' },
                      { field: 'q15_text', label: 'Domanda 15: Testo (classifica top 3 da D14)', type: 'textarea' },
                      { field: 'q15_subtext', label: 'Domanda 15: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q16_text', label: 'Domanda 16: Testo (sensazioni primo ascolto canzone)', type: 'textarea' },
                      { field: 'q16_subtext', label: 'Domanda 16: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q16_options', label: 'Domanda 16: Opzioni sensazioni (separate da virgola)', type: 'array' },
                    ]},
                    { step: 4, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q17_text', label: 'Domanda 17: Testo (5 concetti identità e classifica)', type: 'textarea' },
                      { field: 'q17_subtext', label: 'Domanda 17: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q17_options', label: 'Domanda 17: Opzioni concetti (separate da virgola)', type: 'array' },
                    ]},
                    { step: 5, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q18_text', label: 'Domanda 18: Testo (esperienza / persona formativa)', type: 'textarea' },
                      { field: 'q18_subtext', label: 'Domanda 18: Sottotesto', type: 'textarea' },
                      { field: 'q18_placeholder', label: 'Segnaposto: Domanda 18', type: 'text' },
                      { field: 'q19_text', label: 'Domanda 19: Testo (traguardo di cui essere orgoglioso)', type: 'textarea' },
                      { field: 'q19_subtext', label: 'Domanda 19: Sottotesto', type: 'text' },
                      { field: 'q19_placeholder', label: 'Segnaposto: Domanda 19', type: 'text' },
                      { field: 'q20_text', label: 'Domanda 20: Testo (qualcosa da dimostrare)', type: 'textarea' },
                      { field: 'q20_subtext', label: 'Domanda 20: Sottotesto', type: 'text' },
                      { field: 'q20_placeholder', label: 'Segnaposto: Domanda 20', type: 'text' },
                      { field: 'q21_text', label: 'Domanda 21: Testo (caratteristica da mantenere)', type: 'textarea' },
                      { field: 'q21_placeholder', label: 'Segnaposto: Domanda 21', type: 'text' },
                    ]},
                    { step: 6, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q22_text', label: 'Domanda 22: Testo (effetto della musica sulle persone)', type: 'textarea' },
                      { field: 'q22_subtext', label: 'Domanda 22: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q22_options', label: 'Domanda 22: Opzioni effetti (separate da virgola)', type: 'array' },
                      { field: 'q23_text', label: 'Domanda 23: Testo (elementi riconoscibili nel tempo)', type: 'textarea' },
                      { field: 'q23_subtext', label: 'Domanda 23: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q23_options', label: 'Domanda 23: Opzioni elementi (separate da virgola)', type: 'array' },
                      { field: 'q24_text', label: 'Domanda 24: Testo (cosa desideri ottenere con la musica)', type: 'textarea' },
                      { field: 'q24_subtext', label: 'Domanda 24: Istruzioni / Sottotesto', type: 'text' },
                      { field: 'q24_options', label: 'Domanda 24: Opzioni obiettivi (separate da virgola)', type: 'array' },
                    ]},
                    { step: 7, fields: [
                      { field: 'title', label: 'Titolo dello step', type: 'text' },
                      { field: 'q25_text', label: 'Domanda 25: Titolo (I MOOD VISIVI)', type: 'text' },
                      { field: 'q25_subtext', label: 'Domanda 25: Istruzioni / Sottotesto', type: 'textarea' },
                      { field: 'q25_label', label: 'Domanda 25: Etichetta campo risposta', type: 'textarea' },
                      { field: 'q25_placeholder', label: 'Segnaposto: Domanda 25', type: 'text' },
                      { field: 'q26_text', label: 'Domanda 26: Titolo (I SIMBOLI)', type: 'text' },
                      { field: 'q26_subtext', label: 'Domanda 26: Istruzioni / Sottotesto', type: 'textarea' },
                      { field: 'q26_label', label: 'Domanda 26: Etichetta campo risposta', type: 'textarea' },
                      { field: 'q26_placeholder', label: 'Segnaposto: Domanda 26', type: 'text' },
                    ]}
                  ]
