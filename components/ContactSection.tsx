...
const ContactSection: React.FC = () => {
  ...
  const handleSimpleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLoading(false);
      alert("Impossibile connettersi al server dei contatti.");
    }
  };
    ...
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-12">
        ...
        <div className="mt-2 flex flex-col items-center justify-center gap-1">
          ...
          <Link 
            to="/questionario" 
            className="text-sm font-semibold text-primary hover:text-primary/80 underline decoration-primary/40 underline-offset-4 hover:decoration-primary transition-all inline-flex items-center gap-1.5"
          >
            <span>Questionario di Brand Identity</span>
            <span>→</span>
          </Link>
        </div>
